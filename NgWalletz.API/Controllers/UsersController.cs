namespace NgWalletz.API.Controllers
{
    ...
    using NgWalletz.API.Entities;
    using Microsoft.AspNet.Identity.Owin;
    using NgWalletz.API.Results;
    ...
    public class UserController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            User user = await authRepository.FindAsync(new UserLoginInfo(externalLogin.LoginProvider, externalLogin.ProviderKey));
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            User user = await authRepository
                .FindAsync(new UserLoginInfo(model.Provider, verifiedAccessToken.user_id));
        ...
        public async Task<IHttpActionResult> ObtainLocalAccessToken(string provider, string externalAccessToken)
        {
            ...
            User user = await authRepository.FindAsync(new UserLoginInfo(provider, verifiedAccessToken.user_id));
